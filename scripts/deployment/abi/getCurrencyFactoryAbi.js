...
solc.loadRemoteVersion(compilerVersion, function(err, solcSnapshot) {
  ...
  var contractObj = contractCompiled.contracts['CurrencyFactory.sol:CurrencyFactory']
  var abi = contractObj.interface

  var filePath = __dirname + '/../output/CurrencyFactoryABI_' + compilerVersion + '_' + now + '.json'
