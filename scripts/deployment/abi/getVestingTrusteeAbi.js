...
solc.loadRemoteVersion(compilerVersion, function(err, solcSnapshot) {
  ...
  var contractObj = contractCompiled.contracts['VestingTrustee.sol:VestingTrustee']
  var abi = contractObj.interface

  var filePath = __dirname + '/../output/VestingTrusteeABI_' + compilerVersion + '_' + now + '.json'
