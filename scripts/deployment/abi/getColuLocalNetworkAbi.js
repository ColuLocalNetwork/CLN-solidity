...
solc.loadRemoteVersion(compilerVersion, function(err, solcSnapshot) {
  ...
  var contractObj = contractCompiled.contracts['ColuLocalNetwork.sol:ColuLocalNetwork']
  var abi = contractObj.interface

  var filePath = __dirname + '/../output/ColuLocalNetworkABI_' + compilerVersion + '_' + now + '.json'
